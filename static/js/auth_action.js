(function initAuthActionPage() {
  ...
  const ERROR_MESSAGES = {
    "auth/expired-action-code": "リンクの有効期限が切れています。Memoに戻って確認メールを再送してください。",
    "auth/invalid-action-code": "リンクが無効、またはすでに使用済みです。Memoに戻って認証状況を更新してください。",
  ...
  function translateError(error) {
    return ERROR_MESSAGES[error?.code] || "認証処理に失敗しました。Memoに戻って確認メールを再送してください。";
  }
